...
type EvalRequest struct {
	Experiments []*elwin_storage.Experiment `protobuf:"bytes,1,rep,name=experiments" json:"experiments,omitempty"`
}

func (m *EvalRequest) Reset()                    { *m = EvalRequest{} }
func (*EvalRequest) ProtoMessage()               {}
func (*EvalRequest) Descriptor() ([]byte, []int) { return fileDescriptorElwin, []int{2} }

func (m *EvalRequest) GetExperiments() []*elwin_storage.Experiment {
	if m != nil {
		return m.Experiments
	}
	return nil
...
func (*EvalReply) Descriptor() ([]byte, []int) { return fileDescriptorElwin, []int{3} }

func (m *EvalReply) GetExperiments() []*Experiment {
	if m != nil {
		return m.Experiments
	}
	return nil
...
func (*Requirement) Descriptor() ([]byte, []int) { return fileDescriptorElwin, []int{4} }
...
func (*ExperimentList) Descriptor() ([]byte, []int) { return fileDescriptorElwin, []int{5} }
...
func (*Experiment) Descriptor() ([]byte, []int) { return fileDescriptorElwin, []int{6} }
...
func (*Param) Descriptor() ([]byte, []int) { return fileDescriptorElwin, []int{7} }
...
func init() {
	...
	proto.RegisterType((*EvalRequest)(nil), "elwin.api.EvalRequest")
	golang_proto.RegisterType((*EvalRequest)(nil), "elwin.api.EvalRequest")
	proto.RegisterType((*EvalReply)(nil), "elwin.api.EvalReply")
	golang_proto.RegisterType((*EvalReply)(nil), "elwin.api.EvalReply")
...
func (this *EvalRequest) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*EvalRequest)
	if !ok {
		that2, ok := that.(EvalRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *EvalReply) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*EvalReply)
	if !ok {
		that2, ok := that.(EvalReply)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *EvalRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&elwin.EvalRequest{")
	if this.Experiments != nil {
		s = append(s, "Experiments: "+fmt.Sprintf("%#v", this.Experiments)+",\n")
	}
	s = append(s, "}")
...
func (this *EvalReply) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&elwin.EvalReply{")
	if this.Experiments != nil {
		s = append(s, "Experiments: "+fmt.Sprintf("%#v", this.Experiments)+",\n")
	}
	s = append(s, "}")
...
func (c *elwinClient) Eval(ctx context.Context, in *EvalRequest, opts ...grpc.CallOption) (*EvalReply, error) {
	out := new(EvalReply)
	err := grpc.Invoke(ctx, "/elwin.api.Elwin/Eval", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Elwin_Eval_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EvalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ElwinServer).Eval(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elwin.api.Elwin/Eval",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ElwinServer).Eval(ctx, req.(*EvalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *EvalReply) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *EvalReply) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (this *EvalRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&EvalRequest{`,
		`Experiments:` + strings.Replace(fmt.Sprintf("%v", this.Experiments), "Experiment", "elwin_storage.Experiment", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *EvalReply) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&EvalReply{`,
		`Experiments:` + strings.Replace(fmt.Sprintf("%v", this.Experiments), "Experiment", "Experiment", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *EvalRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Experiments = append(m.Experiments, &elwin_storage.Experiment{})
			if err := m.Experiments[len(m.Experiments)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *EvalReply) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EvalReply: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EvalReply: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorElwin = []byte{
	...
	,
}
